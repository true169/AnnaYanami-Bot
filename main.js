 ...
 * Base By Xinz
 * Created On 6/6/2025
 * Contact Me on wa.me/6287860644193
 * Error Atau Semacamnya Hubungi Via WhatsApp
...
if (usePairingCode && !conn.authState.creds.registered) {
  ...
  } while (!/^[1-9][0-9]{7,15}$/.test(phoneNumber))
  rl.close()
...
global.reloadHandler = async function (restatConn) {
  ...
  conn.welcome = 'Selamat Datang Di Grup @user,'
